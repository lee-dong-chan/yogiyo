...
const Search = (): JSX.Element => {
  ...
  return (
    <div
      className={`relative h-[6rem] w-screen  min-w-[60rem] flex justify-center overflow-hidden`}
    >
      <img
        src="/imgs/bg-top.png"
        className="absolute h-[14rem] top-[-110%] w-screen"
      ></img>
      <div className={`${Center} relative top-[20%]`}>
        <div>
          <img
